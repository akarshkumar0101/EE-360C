...
//        return alphaBetaMax(0,0,length, MIN_WORST) - initCollectGold;
    ...
    /**
     * Solves the given cities problem and returns solution. Also builds up the OPT matrix.
     * @return the optimal gold the king can reap.
     */
        ...
        for(int right=0;right<=length;right++){
            for(int left = right;left>=0;left--){
                ...
                //one city left
                    ...
                    MAX[left][right] = calculateMaxOverWallPositions(left, right);
                }
            }
        }
        return MAX[0][length];
    ...
    /**
     * Calculates a box value like described in the report
     * @param left the left index of the subarray, inclusive
     * @param right the right index of the subarray, exclusive
     * @return the OPT value of the box
     */
    private int calculateMaxOverWallPositions(int left, int right){
    ...
    /**
     * Finds all subarray sums in O(n^2) time.
     */
